...
class resnet_v1_101_fpn_rcnn_l1(Symbol):
    def __init__(self):
        """
    ...
    def get_resnet_backbone(self, data, with_dilated=False, with_dconv=False, with_dpyramid=False, eps=1e-5):
        ...
        return conv1_relu, res2c_relu, res3b3_relu, res4b22_relu, res5c_relu

    def get_fpn_feature(self, c1, c2, c3, c4, c5, feature_dim=256):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        roi_pool = mx.symbol.Custom(data_p1=fpn_p1,data_p2=fpn_p2, data_p3=fpn_p3, data_p4=fpn_p4,
