...
class resnet_v1_101_fpn_dcn_rcnn_l1(Symbol):
    def __init__(self):
        """
        Use __init__ to define parameter network needs
        """
        self.shared_param_list = [ 'offset_p1','offset_p2', 'offset_p3', 'offset_p4', 'offset_p5',
    ...
    def get_fpn_feature(self, c0, c1, c2, c3, c4, c5, feature_dim=256):
        ...
        return fpn_p1, fpn_p2, fpn_p3, fpn_p4, fpn_p5, fpn_p6
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        res0, res1, res2, res3, res4, res5 = self.get_resnet_backbone(data, with_dpyramid=True, with_dconv=True)
        fpn_p1, fpn_p2, fpn_p3, fpn_p4, fpn_p5, fpn_p6 = self.get_fpn_feature(res0, res1, res2, res3, res4, res5)
        ...
        if is_train:
            ...
            # ROI proposal
            rois = mx.sym.Custom(**dict(arg_dict.items() + aux_dict.items()))
        #offset_p0_weight = mx.sym.Variable(name='offset_p0_weight', dtype=np.float32, lr_mult=0.01)
        offset_p1_weight = mx.sym.Variable(name='offset_p1_weight', dtype=np.float32, lr_mult=0.01)
        ...
        #offset_p0_bias = mx.sym.Variable(name='offset_p0_bias', dtype=np.float32, lr_mult=0.01)
        offset_p1_bias = mx.sym.Variable(name='offset_p1_bias', dtype=np.float32, lr_mult=0.01)
        ...
        roi_pool = mx.symbol.Custom(data_p1=fpn_p1,data_p2=fpn_p2, data_p3=fpn_p3, data_p4=fpn_p4, data_p5=fpn_p5,
                                    ...
                                    with_deformable=True,feat_strides='(2,4,8,16,32)')
