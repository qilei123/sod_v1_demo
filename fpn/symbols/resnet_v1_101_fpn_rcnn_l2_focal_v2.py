...
class resnet_v1_101_fpn_rcnn_l2_focal_v2(Symbol):
    def __init__(self):
        """
    ...
    def get_fpn_feature_v2(self, c0, c1, c2, c3, c4, c5, feature_dim=256):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        fpn_p2, fpn_p3, fpn_p4, fpn_p5, fpn_p6 = self.get_fpn_feature(res0, res1, res2, res3, res4, res5)
