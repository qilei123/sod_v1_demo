...
class resnet_unet_rcnn_l0(Symbol):
    def __init__(self):
        """
    ...
    def get_unet_backbone(self, data, with_dilated=False, with_dconv=False, with_dpyramid=False, eps=1e-5):
        ...
        conv1 = mx.sym.BatchNorm(conv1, name='bn1_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv1 = mx.sym.BatchNorm(conv1, name='bn1_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv2 = mx.sym.BatchNorm(conv2, name='bn2_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv2 = mx.sym.BatchNorm(conv2, name='bn2_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv3 = mx.sym.BatchNorm(conv3, name='bn3_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv3 = mx.sym.BatchNorm(conv3, name='bn3_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv4 = mx.sym.BatchNorm(conv4, name='bn4_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv4 = mx.sym.BatchNorm(conv4, name='bn4_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv5 = mx.sym.BatchNorm(conv5, name='bn5_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv5 = mx.sym.BatchNorm(conv5, name='bn5_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv6 = mx.sym.BatchNorm(conv6, name='bn6_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv6 = mx.sym.BatchNorm(conv6, name='bn6_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv7 = mx.sym.BatchNorm(conv7, name='bn7_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv7 = mx.sym.BatchNorm(conv7, name='bn7_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv8 = mx.sym.BatchNorm(conv8, name='bn8_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv8 = mx.sym.BatchNorm(conv8, name='bn8_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv9 = mx.sym.BatchNorm(conv9, name='bn9_1',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv9 = mx.sym.BatchNorm(conv9, name='bn9_2',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv6 = mx.sym.BatchNorm(conv6, name='bn6_3',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv7 = mx.sym.BatchNorm(conv7, name='bn7_3',use_global_stats=False, fix_gamma=False, eps=eps)
        ...
        conv8 = mx.sym.BatchNorm(conv8, name='bn8_3',use_global_stats=False, fix_gamma=False, eps=eps)
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        conv9, conv8, conv7, conv6 = self.get_unet_backbone(data)
    ...
    def get_symbol_resnet(self, cfg, is_train=True):
    ...
    def init_weight_fpn(self, cfg, arg_params, aux_params):
        #print self.arg_shape_dict['bn1_1_moving_mean']
        '''
