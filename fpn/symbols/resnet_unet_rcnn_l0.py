...
class resnet_unet_rcnn_l0(Symbol):
    ...
    def get_unet_backbone(self, data, with_dilated=False, with_dconv=False, with_dpyramid=False, eps=1e-5):
        ...
        conv7 = mx.symbol.Convolution(conv7, num_filter=32, kernel=(3,3), pad=(1,1), name='conv7_3')
        conv7 = mx.symbol.BatchNorm(conv7, name='bn7_3',use_global_stats=False, fix_gamma=False, eps=eps)
        conv7 = mx.symbol.Activation(conv7, act_type='relu', name='relu7_3')
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        roi_pool = mx.symbol.Custom(data_p0=conv9,data_p1=conv8,#data_p2=conv7, data_p3=conv6,
                                    rois=rois, op_type='fpn_roi_pooling', name='fpn_roi_pooling',feat_strides='(1,2)')
