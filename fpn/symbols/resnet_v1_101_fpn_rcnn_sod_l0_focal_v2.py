...
class resnet_v1_101_fpn_rcnn_sod_l0_focal_v2(Symbol):
    ...
    def get_fpn_feature(self, c0, c1, c2, c3, c4, c5, feature_dim=64):
        ...
        '''
        #fpn_p5_upsample = mx.symbol.UpSampling(fpn_p5_1x1, scale=2, sample_type='nearest', name='fpn_p5_upsample')
        fpn_p5_deconv = mx.symbol.Deconvolution(fpn_p5_1x1,kernel=(1,1), stride=(1,1),num_filter=feature_dim,name='fpn_p5_deconv')
        fpn_p4_plus = mx.sym.ElementWiseSum(*[fpn_p5_deconv, fpn_p4_1x1], name='fpn_p4_sum')
        fpn_p4_deconv = mx.symbol.Deconvolution(fpn_p4_plus,kernel=(1,1), stride=(1,1),num_filter=feature_dim,name='fpn_p4_deconv')
        fpn_p3_plus = mx.sym.ElementWiseSum(*[fpn_p4_deconv, fpn_p3_1x1], name='fpn_p3_sum')
        fpn_p3_deconv = mx.symbol.Deconvolution(fpn_p3_plus,kernel=(1,1), stride=(1,1),num_filter=feature_dim,name='fpn_p3_deconv')
        fpn_p2_plus = mx.sym.ElementWiseSum(*[fpn_p3_deconv, fpn_p2_1x1], name='fpn_p2_sum')
        fpn_p2_deconv = mx.symbol.Deconvolution(fpn_p2_plus,kernel=(1,1), stride=(1,1),num_filter=feature_dim,name='fpn_p2_deconv')
        fpn_p1_plus = mx.sym.ElementWiseSum(*[fpn_p2_deconv, fpn_p1_1x1], name='fpn_p1_sum')
        fpn_p1_deconv = mx.symbol.Deconvolution(fpn_p1_plus,kernel=(1,1), stride=(1,1),num_filter=feature_dim,name='fpn_p1_deconv')
    ...
    def get_rpn_subnet(self, data, num_anchors, suffix):
        rpn_conv = mx.sym.Convolution(data=data, kernel=(3, 3), pad=(1, 1), num_filter=32, name='rpn_conv_' + suffix,
